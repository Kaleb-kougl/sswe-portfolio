# Fit report: Platform Engineer, Developer Experience
...
- **Strong**: 4+ years of software engineering experience
  8 years in software since 2018, including an internship (2026 − 2018), meets the 4 asked.
- **Strong**: Strong TypeScript and Node.js
...
- **Strong**: Experience with build tooling (Webpack, Vite, or Rollup)
  Evidence: Halved Webpack build time (IBM), Bundle cut from 6 MB to 300 KB (IBM), Led the OneHost micro-frontend migration (Indeed). Any one example counts.
...
- **Strong**: You've led a large-scale codebase migration
  Evidence: Led the OneHost micro-frontend migration (Indeed), Co-architected OneHost, led 6 engineers (Indeed), Mentored ~12 engineers (Indeed).
  - Led the OneHost micro-frontend migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
...
- **Strong**: Build and maintain our internal CI/CD pipelines on GitHub Actions
  Evidence: GitHub Actions CI with Vitest and Playwright (This portfolio site), Led the OneHost micro-frontend migration (Indeed).
  ...
  - Led the OneHost micro-frontend migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
- **Strong**: Own the Webpack and module federation setup for 30+ micro-frontends
  Evidence: Led the OneHost micro-frontend migration (Indeed), Co-architected OneHost, led 6 engineers (Indeed), Halved Webpack build time (IBM).
  - Led the OneHost micro-frontend migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
  - Co-architected OneHost, led 6 engineers (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
  - Halved Webpack build time (IBM): [Résumé: Software Engineer II, IBM](https://kalebkougl-portfolio.vercel.app/#career)
...
- **Strong**: Partner with product teams to improve build times and developer productivity
  Evidence: Halved Webpack build time (IBM), 10% shorter cycle time with AI tooling (Indeed), Bundle cut from 6 MB to 300 KB (IBM).
  - Halved Webpack build time (IBM): [Résumé: Software Engineer II, IBM](https://kalebkougl-portfolio.vercel.app/#career)
  - 10% shorter cycle time with AI tooling (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
  - Bundle cut from 6 MB to 300 KB (IBM): [Résumé: Software Engineer II, IBM](https://kalebkougl-portfolio.vercel.app/#career)
- **Gap**: Bazel or Nx monorepo experience
  Not in my work yet. Closest frontend platform work: IBM Developer rebuild for SEO and vitals (IBM).
- **Gap**: Kubernetes
  Not in my work yet.
