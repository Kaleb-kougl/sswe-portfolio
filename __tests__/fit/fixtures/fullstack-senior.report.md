...
**4.5 of 6 must-haves covered** (strong counts 1, partial counts ½; not-assessed rows are left out)
...
- **Gap**: PostgreSQL schema design and query tuning
  Not in my work yet.
- **Partial**: Designing REST and GraphQL APIs
  Evidence: GolfTV GraphQL API on AWS (IBM), Co-architected OneHost, led 6 engineers (Indeed), Pattern system of pure functions (r3f-projectiles). Nothing for REST.
...
- **Not assessed**: Owning an on-call rotation
