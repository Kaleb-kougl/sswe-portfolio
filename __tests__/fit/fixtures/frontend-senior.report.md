...
- **Strong**: Deep knowledge of web accessibility (WCAG 2.1 AA)
  ...
  - WCAG across 20+ React components (Indeed): [Résumé: Software Engineer II, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
- **Strong**: Improving Core Web Vitals and frontend performance
...
- **Partial**: Strong testing habits (Jest, React Testing Library)
  Evidence: React Native features with Jest and Appium (J.B. Hunt), 149 passing tests (Agentic AI Video Creator). Nothing for React Testing Library.
  ...
  - 553 assertions across 13 spec files (r3f-projectiles): [r3f-projectiles on GitHub](https://github.com/Kaleb-kougl/r3f-projectiles)
...
- **Gap**: Next.js and server-side rendering
  Not in my work yet.
- **Strong**: GraphQL
