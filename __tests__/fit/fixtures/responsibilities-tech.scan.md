...
- **Strong**: Build and maintain our internal CI/CD pipelines on GitHub Actions
  Evidence: Led the OneHost micro-frontend migration (Indeed), GitHub Actions CI with Vitest and Playwright (This portfolio site).
  - Led the OneHost micro-frontend migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
...
- **Strong**: Migrate legacy services from JavaScript to TypeScript, one package at a time
  Evidence: Luxon timezone migration (Indeed), GenAI Chrome extension, 20% faster troubleshooting (Indeed Analytics Extension), Led the OneHost micro-frontend migration (Indeed).
  - Luxon timezone migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
  - GenAI Chrome extension, 20% faster troubleshooting (Indeed Analytics Extension): [Work: Indeed Analytics Extension (internal, no public link)](https://kalebkougl-portfolio.vercel.app/#work)
  - Led the OneHost micro-frontend migration (Indeed): [Résumé: Senior Software Engineer, Indeed.com](https://kalebkougl-portfolio.vercel.app/#career)
