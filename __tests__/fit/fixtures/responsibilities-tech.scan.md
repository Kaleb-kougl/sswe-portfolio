...
- **Strong**: Experience with build tooling (Webpack, Vite, or Rollup)
  Evidence: Halved Webpack build time (IBM), Bundle cut from 6 MB to 300 KB (IBM), Led the OneHost micro-frontend migration (Indeed).
...
- **Partial**: Build and maintain our internal CI/CD pipelines on GitHub Actions
...
- **Not assessed**: Bazel or Nx monorepo experience
