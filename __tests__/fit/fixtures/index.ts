...
- Mentoring other engineers`,
    ...
    labels: [
      ...
      must('Strong testing habits (Jest, React Testing Library)', 'jest', 'automated-testing'),
      must('Excellent written communication'),
      nice('Micro-frontends or Module Federation', 'micro-frontends', 'module-federation'),
      nice('Next.js and server-side rendering'),
...
- Kubernetes`,
    ...
    labels: [
      nice('Build and maintain our internal CI/CD pipelines on GitHub Actions', 'ci-cd'),
...
• 20 days PTO`,
    ...
    labels: [
      ...
      must('Experience with SQL databases and Kafka'),
